...
/**
    Este metodo devuelve todos los datos de un objeto.
...
/**
    Este método es el que genera los datos asociados a valores numéricos del archivo leído.
    @param int par referencia el parametro del que estamos obteniendo los datos.
**/
...
/**
    Este método es el que genera los datos asociados a valores literales del archivo leído.
    @param int param referencia el parametro del que estamos obteniendo los datos.
**/
