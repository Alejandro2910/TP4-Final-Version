...
/**
    Este método se encarga de escribir los datos generados en el archivo de escritura
**/
void Lector::escriba(){
    if(escr){
...
/**
    Este método se encarga de abrir el archivo de escritura asociado al nombre proporcionado por el usuario.
    @param string dir es el nombre del archvio de escritura.
**/
...
/**
    Este método se encarga de cerrar el archivo de escritura.
**/
...
/**
    Este método se encarga de llamar a los metodos de la clase ListaObjetos para generar los datos
    probabilísticos y literales del archivo leido.
    @param ListaObjetos &l es usado para llamar los métodos de la clase sin importarla.
**/
